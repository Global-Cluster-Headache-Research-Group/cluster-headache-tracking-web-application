...
public class AttackController {
    ...
    public Page<Attack> findAll(
        ...
        AttackSpecification specification = createSpecification(patientId, fromDate, toDate, minPainLevel, maxPainLevel, whileAsleep, abortiveTreatmentTypeId);
    ...
    private AttackSpecification createSpecification(int patientId, LocalDate fromDate, LocalDate toDate, Integer minPainLevel, Integer maxPainLevel, Boolean whileAsleep,
