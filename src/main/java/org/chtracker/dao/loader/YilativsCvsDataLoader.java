...
import org.chtracker.dao.report.repositories.PreventiveTreatmentRepository;
	...
	void saveAbortiveTreatments(Attack attack, String treatmentsString, LocalDateTime started, LocalDateTime stopped, String statusesString, String comments) {
		if (StringUtils.hasText(treatmentsString)) {
			...
			for (String treatmentString : treatmentStrings) {
				...
				i++;
				saveAbortiveTreatment(attack, treatmentsString, started, stopped, comments, status, treatmentString);
			}
		}

	}

	private void saveAbortiveTreatment(Attack attack, String treatmentsString, LocalDateTime started, LocalDateTime stopped, String comments, Boolean status, String treatmentString) {
		try {
